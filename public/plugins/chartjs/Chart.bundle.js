...
;(function (global, factory) {
        ...
        if (config !== null) {
            ...
            if (locales[name] != null) {
                deprecateSimple('defineLocaleOverride',
                        ...
                        'See http://momentjs.com/gprovider_ides/#/warnings/define-locale/ for more info.');
                ...
                if (locales[config.parentLocale] != null) {
                    ...
                    deprecateSimple('parentLocaleUndefined',
                            'specified parentLocale is not defined yet. See http://momentjs.com/gprovider_ides/#/warnings/parent-locale/');
                }
            }
    ...
    utils_hooks__hooks.createFromInputFallback = deprecate(
        ...
        'http://momentjs.com/gprovider_ides/#/warnings/js-date/ for more info.',
        function (config) {
    ...
    var prototypeMin = deprecate(
        'moment().min is deprecated, use moment.max instead. http://momentjs.com/gprovider_ides/#/warnings/min-max/',
        function () {
    ...
    var prototypeMax = deprecate(
        'moment().max is deprecated, use moment.min instead. http://momentjs.com/gprovider_ides/#/warnings/min-max/',
        function () {
            var other = local__createLocal.apply(null, arguments);
            if (this.isValid() && other.isValid()) {
                return other > this ? this : other;
    ...
    function createAdder(direction, name) {
        return function (val, period) {
            ...
            if (period !== null && !isNaN(+period)) {
                ...
                'See http://momentjs.com/gprovider_ides/#/warnings/add-inverted-param/ for more info.');
    ...
    momentPrototype__proto.zone   = deprecate('moment().zone is deprecated, use moment().utcOffset instead. http://momentjs.com/gprovider_ides/#/warnings/zone/', getSetZone);
    momentPrototype__proto.isDSTShifted = deprecate('isDSTShifted is deprecated. See http://momentjs.com/gprovider_ides/#/warnings/dst-shifted/ for more information', isDaylightSavingTimeShifted);
