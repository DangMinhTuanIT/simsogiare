...
/*jsc
["tinymce/inlite/Theme","global!tinymce.ThemeManager","global!tinymce.util.Delay","tinymce/inlite/ui/Panel","tinymce/inlite/ui/Buttons","tinymce/inlite/core/SkinLoader","tinymce/inlite/core/SelectionMatcher","tinymce/inlite/core/ElementMatcher","tinymce/inlite/core/Matcher","tinymce/inlite/alien/Arr","tinymce/inlite/core/PredicateId","global!tinymce.util.Tools","global!tinymce.ui.Factory","global!tinymce.DOM","tinymce/inlite/ui/Toolbar","tinymce/inlite/ui/Forms","tinymce/inlite/core/Measure","tinymce/inlite/core/Layout","tinymce/inlite/file/Conversions","tinymce/inlite/file/Picker","tinymce/inlite/core/Actions","global!tinymce.EditorManager","global!tinymce.util.Promise","tinymce/inlite/alien/Uprovider_id","tinymce/inlite/alien/Unlink","tinymce/inlite/core/UrlType","global!tinymce.geom.Rect","tinymce/inlite/core/Convert","tinymce/inlite/alien/Bookmark","global!tinymce.dom.TreeWalker","global!tinymce.dom.RangeUtils"]
jsc*/
 ...
 */
define("tinymce/inlite/alien/Uprovider_id", [
], function() {
	var count = 0;
	...
	var uprovider_id = function (prefix) {
		return prefix + (count++) + seed();
	};

	return {
		uprovider_id: uprovider_id
	};
});
...
define('tinymce/inlite/core/Actions', [
	'tinymce/inlite/alien/Uprovider_id',
	'tinymce/inlite/alien/Unlink'
], function (Uprovider_id, Unlink) {
	...
	var insertBlob = function (editor, base64, blob) {
		...
		blobInfo = blobCache.create(Uprovider_id.uprovider_id('mceu'), blob, base64);
