...
See the [Installing CKEditor with Package Managers](http://docs.ckeditor.com/#!/gprovider_ide/dev_package_managers) article for more details about installing CKEditor with [Bower](http://bower.io/), [Composer](https://getcomposer.org/) and [npm](https://www.npmjs.com/).
