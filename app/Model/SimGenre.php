...
class SimGenre extends Model{
	protected $table = 'sim_genre';
    ...
    {
        return DB::table('sim_genre as s')->select('s.*')->get();
    }
    ...
    public static function search($params = ''){
        ...
        $items = DB::table('sim_genre as s')
        ->orderBy('s.weight','asc')
        ->where('s.name_genre', 'like', '%' . $params . '%')
            ->select('s.*');
    ...
    public static function removeAll(){
        return DB::table('sim_genre')->truncate();
    }

    public static function batchRemove($params){
        return DB::table('sim_genre')
            ->whereIn('id', $params)
            ->delete();
    }
