               ...
               <div class="filter_search search_area">
                  ...
                  <div class="block-search">
                     <div class="sims_select_filter">
                      {!!WebService::dauso_slug3_first_name($type,@$slug_cat,@$id_category,@$slug1,@$slug2,@$slug3)!!}
                       {!!WebService::category_network_category_slug3(@$filter_according,@$slug1,@$slug2,@$slug3)!!}
                        {!!WebService::price_range_category_slug3(@$filter_according,@$slug1,@$slug2,@$slug3)!!}
