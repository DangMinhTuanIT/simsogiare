            ...
            <div class="main-area-right cls">
               <div class="search_area">
                  <div class="note_title">
                     <h1> <span>{{$info->name_sim_year}}</span></h1>
                  </div>
                  <div class="sumary_sim">{{$info->name_sim_year}} - Sở hữu sim phong thủy hợp tuổi hợp mệnh sẽ mang đến cho bạn nguồn năng lượng tích cực, giúp hóa giải vận hạn, gia tăng vượng khí. </div>
               </div>
