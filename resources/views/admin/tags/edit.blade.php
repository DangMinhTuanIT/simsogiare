...
@endsection
@section('content')
<form class="form_validation collapse{{ (old('data')) ? ' in' : '' }} in" enctype="multipart/form-data"  id="formDemo" action="<?php echo URL::to('admin/tags/update/'.$info->id);?>" method="post" role="form">
   ...
   <div class="row clearfix">
      <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
         <div class="card">
            ...
            <div class="body">
               <!--  -->
               <h3 class="section-title tit section-title-bold"><b></b><span class="section-title-main">Sửa Tags</span><b></b></h3>
               <div class="number_of_items m-t-20">
                  <div class="hub_items">
                     <button type="submit" class="btn bg-teal btn-lg waves-effect">EDIT</button>
                     <p><hr>Demo Link: <a href="@php echo  URL::to('tags/'.$info->slug).'.html'; @endphp " target="_blank">@php echo  URL::to('tags/'.$info->slug.'.html')@endphp </a>
                     <hr></p>
                     <div class="row clearfix hub_item">
                        <div class="col-md-12 col-sm-12 col-xs-12 margin0">
                           <div class="form-group form-float">
                              ...
                              <div class="form-line">
                                 <input type="text" class="form-control title_slugify" name="title" value="{{ $info->title }}" placeholder="Tên Tags" required>
                              </div>
                           </div>
                        </div>
                       <div class="col-md-12 col-sm-12 col-xs-12 margin0">
