...
@endsection
@section('content')
<form class="form_validation collapse{{ (old('data')) ? ' in' : '' }} in" enctype="multipart/form-data"  id="formDemo" action="{{ route('tags.create') }}" method="post" role="form">
   ...
   <div class="row clearfix">
      <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
         <div class="card">
            ...
            <div class="body">
               <!--  -->
               <h3 class="section-title tit section-title-bold"><b></b><span class="section-title-main">Thêm Tags</span><b></b></h3>
                     ...
                     <div class="row clearfix hub_item">
                        <div class="col-md-12 col-sm-12 col-xs-12 margin0">
                           <div class="form-group form-float">
                              ...
                              <div class="form-line">
                                 <input type="text" class="form-control title_slugify" name="title" value="{{ old('title') }}" placeholder="Tên tags" required>
                              </div>
                           </div>
                        </div>
                       <div class="col-md-12 col-sm-12 col-xs-12 margin0">
