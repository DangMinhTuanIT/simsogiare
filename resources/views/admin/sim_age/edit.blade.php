...
@endsection
@section('content')
<form class="form_validation collapse{{ (old('data')) ? ' in' : '' }} in" enctype="multipart/form-data"  id="formDemo" action="{{route('sim_age.update_db',array($info->id))}}" method="post" role="form">
    ...
    <div class="col-lg-6">
            <div class="panel panel-default">
                <div class="panel-heading">
                    Thông tin về {{$module_name}}
                </div>
                <div class="panel-body">
                    <div class="form-group">
                        <label><label for="name_sim_age">Tuổi</label></label>
                        <input type="text" id="name_sim_age" name="name_sim_age" value="{{$info->name_sim_age}}" class="form-control title_slugify" placeholder="Tuổi">                    </div>
                    <div class="form-group">
...
</select>                        <p class="help-block">Vị trí sắp xếp của {{$module_name}}, số nhỏ đứng trước.</p>
                    </div>
                    <div class="form-group">
                ...
                <button type="submit" class="btn btn-primary">Cập nhật</button>
                    <a type="button" href="{{route('sim_age.list')}}" class="btn btn-default">Quay lại</a>
                </div>
                <!-- /.panel-body -->
            </div>
            <!-- /.panel -->
            ...
            <div class="panel panel-default">
                ...
                <div class="panel-body">
                    <div class="form-group">
                        ...
                        <input type="text" id="alias" name="alias" value="{{$info->slug}}" class="form-control slug_slugify" placeholder="Đường dẫn thân thiện">                        <p class="help-block">Chỉ được sử dụng các từ a-z 0-9 dấu gạch ngang (-). </p>
                    </div>
                    <div class="form-group">
