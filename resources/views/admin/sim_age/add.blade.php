...
@endsection
@section('content')
<form class="form_validation collapse{{ (old('data')) ? ' in' : '' }} in" enctype="multipart/form-data"  id="formDemo" action="{{ route('sim_age.store') }}" method="post" role="form">
            ...
            <div class="panel panel-default">
                ...
                <div class="panel-body">
                    <div class="form-group">
                        ...
                        <input type="text" id="name_sim_age" name="name_sim_age" value="{{old('name_sim_age')}}" class="form-control title_slugify" placeholder="Tuổi">                    </div>
                    <div class="form-group">
