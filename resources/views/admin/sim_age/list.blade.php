...
@section('content')
<a class="btn bg-teal btn-lg waves-effect m-b-15" href="{{route('sim_age.add')}}">
            THÊM MỚI
        </a>
        
<input type="hidden" name="" value="{{str_replace('/abc','',route('sim_age.edit',array('abc')))}}" class="page_edit">
...
@section('script')
    ...
    <script type="text/javascript">
        dataCenter.searchRoute = '{{ route('sim_age.search') }}';
        dataCenter.filterRoute = '{{ route('sim_age.list') }}';
        dataCenter.truncateRoute = '{{ route('sim_age.truncate') }}';
        ...
        dataCenter.columns = [
            ...
            {data: 'name_sim_age', name: 'name_sim_age'},
        ...
        $(function () {
            ...
            var params = {
                route: '{{ route('sim_age.data') }}' + '?@php echo \App\myHelper::getFilters($filters); @endphp',
