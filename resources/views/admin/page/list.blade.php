...
@section('content')
        ...
        <a class="btn bg-teal btn-lg waves-effect m-b-15" href="{{route('page.add')}}">
            THÊM MỚI
        </a>
<input type="hidden" name="" value="{{URL::to('admin/page/edit/')}}" class="page_edit">
...
@section('script')
    ...
    <script type="text/javascript">
        dataCenter.searchRoute = '{{ route('page.search') }}';
        dataCenter.filterRoute = '{{ route('page.list') }}';
        dataCenter.truncateRoute = '{{ route('page.truncate') }}';
        ...
        dataCenter.tableConfigs.columnDefs = [
            ...
            },
            {
            ...
            },
             {
                ...
                className: '',
                render: function (data, type, row){
                    return '<a target="_blank" href="'+home_url+'/'+ row['slug'] +'">'+row['title']+'</a>';
                }
            },
          
            {
                ...
                className: 'item-checkbox dt-body-center',
                render: function (data, type, row){
                    return '<img src="'+home_url+'/'+ row['thumbnail'] +'" style="width:100px">';
                }
            },
        ...
        $(function () {
            ...
            var params = {
                route: '{{ route('page.data') }}' + '?@php echo \App\myHelper::getFilters($filters); @endphp',
