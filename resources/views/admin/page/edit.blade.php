...
@endsection
@section('content')
<form class="form_validation collapse{{ (old('data')) ? ' in' : '' }} in" enctype="multipart/form-data"  id="formDemo" action="<?php echo URL::to('admin/page/update/'.$info->id);?>" method="post" role="form">
            ...
            <div class="body">
               ...
               <div class="number_of_items m-t-20">
                  <div class="hub_items">
                     ...
                     <p><hr>Demo Link: <a href="@php echo  URL::to($info->slug).''; @endphp " target="_blank">@php echo  URL::to($info->slug).''; @endphp </a>
                     <hr></p>
                     <div class="row clearfix hub_item">
                        <div class="col-md-12 col-sm-12 col-xs-12 margin0">
                           <div class="form-group form-float">
                              ...
                              <div class="form-line">
                                 <input type="text" class="form-control title_slugify" name="title" value="{{ $info->title }}" placeholder="Tên Page" required>
                              </div>
                           </div>
                        </div>
                       <div class="col-md-12 col-sm-12 col-xs-12 margin0">
                        ...
                        <div class="col-md-12 col-sm-12 col-xs-12">
                           ...
                           <div class="form-float">
                              <div> <textarea rows="4" cols="50" id="description" class="description" name="description">{{ $info->content }}</textarea></div>
                           </div>
                        </div>
                          <div class="col-md-12 col-sm-12 col-xs-12">
                       ...
                       <div class="col-md-12 col-sm-12 col-xs-12">
                        ...
                        <div class="col-md-4 col-sm-12 col-xs-12 js">
                           ...
                           <div class="box">
                            <input type="hidden" class="thumbnail" name="thumbnail" value="{{@$info->thumbnail}}">
                             ...
                             <div class="img_thumb">
                              <a href="<?php echo URL::to('/').'/'.@$info->thumbnail ?>" data-fancybox="images-preview_1" class="btn-close"> <img src="<?php echo URL::to('/').'/'.@$info->thumbnail ?>" width="150">
                              </a>
                           </div>
                        </div>
                        <div class="clearfix"></div>
