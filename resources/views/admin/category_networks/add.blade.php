...
@endsection
@section('content')
<form class="form_validation collapse{{ (old('data')) ? ' in' : '' }} in" enctype="multipart/form-data"  id="formDemo" action="{{ route('category_networks.store') }}" method="post" role="form">
            ...
            <div class="panel panel-default">
                ...
                <div class="panel-body">
                    <div class="form-group">
                        ...
                        <input type="text" id="name_network" name="name_network" value="{{old('name_network')}}" class="form-control title_slugify" placeholder="Tên nhà mạng, ví dụ: Viettel">                    </div>
                    <div class="form-group">
