...
@endsection
@section('content')
<form class="form_validation collapse{{ (old('data')) ? ' in' : '' }} in" enctype="multipart/form-data"  id="formDemo" action="{{route('sim_birth.update_db',array($info->id))}}" method="post" role="form">
            ...
            <div class="panel panel-default">
                ...
                <div class="panel-body">
                    <div class="form-group">
                        ...
                        <input type="text" id="name_birth" name="name_birth" value="{{$info->name_birth}}" class="form-control" placeholder="Năm Sinh">                    </div>
                    <div class="form-group">
                    ...
                    <div class="form-group">
                      ...
                      <p class="help-block">Vị trí sắp xếp của thể loại, số nhỏ đứng trước. 
</p>
                    </div>
                   <div class="form-group">
