...
@section('content')
<a class="btn bg-teal btn-lg waves-effect m-b-15" href="{{route('genre.add')}}">
            THÊM MỚI
        </a>
...
@section('script')
    ...
    <script type="text/javascript">
        dataCenter.searchRoute = '{{ route('genre.search') }}';
        dataCenter.filterRoute = '{{ route('genre.list') }}';
        dataCenter.truncateRoute = '{{ route('genre.truncate') }}';
        ...
        $(function () {
            ...
            var params = {
                route: '{{ route('genre.data') }}' + '?@php echo \App\myHelper::getFilters($filters); @endphp',
