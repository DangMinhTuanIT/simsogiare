...
@endsection
@section('content')
<form class="form_validation collapse{{ (old('data')) ? ' in' : '' }} in" enctype="multipart/form-data"  id="formDemo" action="{{ route('category.create') }}" method="post" role="form">
   ...
   <div class="row clearfix">
      <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
         <div class="card">
            ...
            <div class="body">
               <!--  -->
               <h3 class="section-title tit section-title-bold"><b></b><span class="section-title-main">Thêm Category</span><b></b></h3>
                     ...
                     <div class="row clearfix hub_item">
                        <div class="col-md-12 col-sm-12 col-xs-12 margin0">
                           <div class="form-group form-float">
                              ...
                              <div class="form-line">
                                 <input type="text" class="form-control title_slugify" name="name" value="{{ old('name') }}" placeholder="Tên Category" required>
                              </div>
                           </div>
                        </div>
                       <div class="col-md-12 col-sm-12 col-xs-12 margin0">
                        ...
                        <div class="col-md-12 col-sm-12 col-xs-12">
                           ...
                           <div class="form-float">
                              <div> <textarea rows="4" cols="50" id="description" class="intro" name="intro">{{ old('intro') }}</textarea></div>
                           </div>
                        </div>
                         <div class="col-md-12 col-sm-12 col-xs-12">
                           ...
                           <div class="form-float">
                              <div class="form-line">
                               <input type="text" class="form-control" id="seo_title" name="site_title" value="{{ old('site_title') }}" placeholder="Site Title">
                          ...
                          <div class="col-md-12 col-sm-12 col-xs-12">
                           ...
                           <div class="form-float">
                              <div> <textarea rows="4" id="seo_keyword" cols="50" style="height: 50px;width:100%;" class="meta_key" name="meta_key">{{ old('meta_key') }}</textarea></div>
