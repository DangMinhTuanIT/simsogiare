...
@endsection
@section('content')
<form class="form_validation collapse{{ (old('data')) ? ' in' : '' }} in" enctype="multipart/form-data"  id="formDemo" action="{{route('price_range.update_db',array($info->id))}}" method="post" role="form">
    ...
    <div class="col-lg-6">
            <div class="panel panel-default">
                <div class="panel-heading">
                    ...
                    <h3>Chỉnh sửa {{$info->name_price_range}}</h3>
                
                </div>
                <div class="panel-body">
                    <div class="form-group">
                        <label><label for="name_price_range">Tên khoảng giá</label></label>
                        <input type="text" id="name_price_range" name="name_price_range" value="{{$info->name_price_range}}" class="form-control" placeholder="Sim dưới 500 nghìn">                    </div>
                         <div class="form-group">
                        <label><label for="price_start">Giá tiền bắt đầu</label></label>
                        <input type="number" id="price_start" name="price_start" value="{{$info->price_start_int}}" class="form-control" placeholder="Giá tiền bắt đầu" data-max-length="100000">                      
                    </div>
                    <div class="form-group">
                        <label><label for="price_end">Giá tiền kết thúc</label></label>
                        <input type="number" id="price_end" name="price_end" value="{{$info->price_end_int}}" class="form-control" placeholder="Giá tiền kết thúc" data-max-length="100000">                    </div>
                    <div class="form-group">
                    ...
                    <div class="form-group">
                      ...
                      <p class="help-block">Vị trí sắp xếp của nhà mạng, số nhỏ đứng trước.
            ...
            <div class="panel panel-default">
                ...
                <div class="panel-body">
                    <div class="form-group">
                        ...
                        <input type="text" id="alias" name="alias" value="{{$info->slug}}" class="form-control" placeholder="Đường dẫn thân thiện">                        <p class="help-block">Chỉ được sử dụng các từ a-z 0-9 dấu gạch ngang (-). Ví dụ: viettel. Nếu không nhập thì được tạo từ động từ tên của nhà mạng</p>
                    </div>
                    <div class="form-group">
