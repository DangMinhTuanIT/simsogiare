...
@endsection
@section('content')
<form class="form_validation collapse{{ (old('data')) ? ' in' : '' }} in" enctype="multipart/form-data"  id="formDemo" action="{{route('sim_fate.update_db',array($info->id))}}" method="post" role="form">
            ...
            <div class="panel panel-default">
                ...
                <div class="panel-body">
                    <div class="form-group">
                        ...
                        <input type="text" id="name_sim_fate" name="name_sim_fate" value="{{$info->name_sim_fate}}" class="form-control title_slugify" placeholder="Mệnh">                    </div>
                    <div class="form-group">
