...
@section('content')
<a class="btn bg-teal btn-lg waves-effect m-b-15" href="{{route('sim_fate.add')}}">
            THÊM MỚI
        </a>
        
<input type="hidden" name="" value="{{str_replace('/abc','',route('sim_fate.edit',array('abc')))}}" class="page_edit">
...
@section('script')
    ...
    <script type="text/javascript">
        dataCenter.searchRoute = '{{ route('sim_fate.search') }}';
        dataCenter.filterRoute = '{{ route('sim_fate.list') }}';
        dataCenter.truncateRoute = '{{ route('sim_fate.truncate') }}';
        ...
        dataCenter.columns = [
            ...
            {data: 'name_sim_fate', name: 'name_sim_fate'},
        ...
        $(function () {
            ...
            var params = {
                route: '{{ route('sim_fate.data') }}' + '?@php echo \App\myHelper::getFilters($filters); @endphp',
